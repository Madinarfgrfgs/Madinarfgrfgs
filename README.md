<html>
    ...
    <body>
        ...
        <main>
            <h1 class="heading">Профессионалы советуют</h1>
            <section class="info">
                <article style="position: realitive" class="post">
                    <img class="img_l" src="https://learn.algoritmika.org/uploads/2021/03/tag-151102.svg"/>
